...
return new class extends Migration
{
    ...
    {
        Schema::create('pm_sms_ingests', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('matched_tenant_id')->nullable()->constrained('pm_tenants')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('pm_sms_ingests');
    }
};
