...
{
    /**
     * LoanBook tables that use Laravel's $table->id(); inserts omit `id` and require AUTO_INCREMENT.
     * (Applications and loans have dedicated repair migrations; this covers the rest.)
     *
     * @var list<string>
     */
