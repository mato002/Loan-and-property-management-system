<x-public-layout>
    ...
    <div class="relative bg-gray-900 border-b border-gray-800">
        ...
        <div class="relative w-full px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 py-32 lg:py-48 flex flex-col items-center text-center">
            <h1 class="text-4xl md:text-6xl font-black text-white tracking-tight mb-6 max-w-4xl">
                Find Your Perfect Space With <span class="text-emerald-400">{{ $brandName }}</span>
            </h1>
            ...
            <form method="get" action="{{ route('public.properties') }}" class="w-full max-w-4xl bg-white p-2 sm:p-3 rounded-2xl shadow-2xl flex flex-col sm:flex-row gap-2 sm:gap-0">
                ...
                <div class="hidden sm:block w-px h-10 bg-gray-200 self-center mx-2"></div>
                <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-8 py-4 rounded-xl transition-colors w-full sm:w-auto text-lg flex items-center justify-center gap-2">
                ...
                <div class="mt-5 flex flex-wrap items-center justify-center gap-2">
                    ...
                    @foreach ($availableUnitTypes as $typeValue => $typeLabel)
                        <a
                            ...
                            class="inline-flex items-center rounded-full border border-white/25 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white hover:bg-white hover:text-emerald-700 transition-colors"
                        >
                            {{ $typeLabel }}
                        </a>
                    @endforeach
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="w-full px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 py-16">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
                <div>
                    <p class="text-4xl font-black text-emerald-600 mb-2">1,200+</p>
                    <p class="text-gray-500 font-medium">Properties Managed</p>
                </div>
                <div>
                    <p class="text-4xl font-black text-emerald-600 mb-2">350+</p>
                    <p class="text-gray-500 font-medium">Happy Landlords</p>
                </div>
                <div>
                    <p class="text-4xl font-black text-emerald-600 mb-2">5,000+</p>
                    <p class="text-gray-500 font-medium">Active Tenants</p>
                </div>
                <div>
                    <p class="text-4xl font-black text-emerald-600 mb-2">15</p>
    ...
    <div class="w-full px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20 py-24">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="{{ route('public.properties') }}" class="hidden md:inline-flex items-center gap-2 text-emerald-600 font-bold hover:text-emerald-700">
                View All Listings
    ...
    <!-- Tenant CTA Area -->
    <div class="bg-gradient-to-r from-slate-900 via-emerald-900 to-slate-900 py-20">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <a href="{{ route('public.properties') }}" class="inline-block bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-10 py-4 rounded-xl shadow-xl shadow-emerald-900/30 transition-transform hover:-translate-y-1">Browse Available Homes</a>
        </div>
    </div>
</x-public-layout>
