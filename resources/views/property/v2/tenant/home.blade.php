    ...
    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-emerald-50 rounded-xl border border-emerald-200 p-4">
                <p class="text-sm font-medium text-emerald-800">Credit balance</p>
                <p class="text-2xl font-bold text-emerald-900 mt-1">{{ $creditBalanceFormatted ?? 'KES 0.00' }}</p>
                <a href="{{ route('property.tenant.credit.history') }}" class="text-xs text-emerald-700 font-medium hover:underline mt-1 inline-block">View history →</a>
            </div>
            <div class="bg-white rounded-xl border border-gray-200 p-4">
