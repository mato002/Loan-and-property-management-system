...
>
    <x-slot name="actions">
        <a href="{{ route('property.landlords.index', ['month' => $monthValue, 'fy' => $fyValue], false) }}" data-turbo-frame="property-main" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
            Back to landlords
        </a>
        ...
        <a href="{{ route('property.landlords.statement', ['landlord' => $landlord->id, 'month' => $monthValue, 'fy' => $fyValue], false) }}" data-turbo-frame="property-main" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Statement</a>
        ...
        <a href="{{ route('property.financials.owner_balances', ['month' => $monthValue, 'fy' => $fyValue], false) }}" data-turbo-frame="property-main" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
            Owner balances
        </a>
        <a href="{{ route('property.financials.commission', ['month' => $monthValue, 'fy' => $fyValue], false) }}" data-turbo-frame="property-main" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
            Commission report
        </a>
    </x-slot>
            ...
            <tbody>
                @forelse($propertyBreakdown as $row)
                    <tr class="border-t border-slate-100 hover:bg-slate-50/70">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('property.properties.show', ['property' => $row['property_id']], false) }}" data-turbo-frame="property-main" class="rounded border border-slate-300 px-2 py-1 text-xs text-slate-700 hover:bg-slate-50">View property</a>
                        </td>
                    </tr>
                @empty
                    <tr>
