...
>
    ...
    @php
        $tenantEditShowOpeningArrears = $errors->hasAny([
            ...
            || count((array) old('opening_arrears_items', (array) ($tenant->opening_arrears_items ?? []))) > 0
            || (float) old('opening_arrears_amount', $tenant->opening_arrears_amount) > 0
