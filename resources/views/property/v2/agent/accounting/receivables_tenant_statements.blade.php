<x-property.workspace
    ...
    :table-rows="$tenants->getCollection()->map(fn($t) => [
        ...
        \App\Services\Property\PropertyMoney::kes((float) \App\Models\PmInvoice::query()->liveBalances()->where('pm_tenant_id', $t->id)->selectRaw('COALESCE(SUM(amount - amount_paid),0) as bal')->value('bal')),
