...
>
    ...
    <x-slot name="toolbar">
        <form method="get" class="flex flex-wrap items-end gap-2">
            ...
            <div>
                <label class="block text-xs font-medium text-slate-600">Search name</label>
                <input type="text" name="q" value="{{ $filters['q'] ?? request('q') }}" placeholder="Landlord name" class="mt-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm" />
            </div>
            <div>
