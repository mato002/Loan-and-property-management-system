<x-property-layout>
    ...
    >
        ...
        <x-property.responsive.stat-card-grid class="mb-4" :stats="[
            ['label' => 'Shortcode', 'value' => $shortcode !== '' ? $shortcode : 'Not set'],
            ['label' => 'Consumer secret', 'value' => $hasConsumerSecret ? 'Configured' : 'Not set'],
