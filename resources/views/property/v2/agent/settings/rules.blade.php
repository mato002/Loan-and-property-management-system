<x-property-layout>
    ...
    >
        ...
        <div class="mb-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/40 p-4">
            <p class="text-sm text-slate-700 dark:text-slate-300">
                Basic grace and late-fee defaults live here. For scoped penalty rules, formulas, and automation, use
                <a href="{{ route('property.revenue.penalties') }}" data-turbo-frame="property-main" class="font-semibold text-emerald-700 hover:underline">Penalty rules engine</a>.
            </p>
        </div>
