    ...
    <x-slot name="toolbar">
        <form method="get" class="flex flex-wrap items-end gap-2">
            ...
            <div>
                ...
                <input type="text" name="q" value="{{ $filters['q'] ?? request('q') }}" placeholder="Landlord or property" class="mt-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm" />
            </div>
            <div>
