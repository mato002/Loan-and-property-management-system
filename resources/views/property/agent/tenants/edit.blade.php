    ...
    <form method="post" action="{{ route('property.tenants.update', $tenant) }}" x-data="{
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="account_number" value="{{ old('account_number', $tenant->account_number) }}" @required($tenantRequired('account_number', false)) class="mt-1 w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-900 text-sm px-3 py-2" />
