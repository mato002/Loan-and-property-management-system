<div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-x-auto">
    <div class="px-4 py-3 border-b border-slate-100 flex flex-wrap items-center justify-between gap-2">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            >New lease</button>
            <a href="{{ route('property.tenants.leases', ['pm_tenant_id' => $tenant->id], false) }}" data-turbo-frame="property-main" class="text-xs font-semibold text-slate-600 hover:underline self-center">Lease register</a>
        </div>
    </div>
    <table class="min-w-full border-collapse text-sm [&_th]:border [&_th]:border-slate-200 [&_td]:border [&_td]:border-slate-200">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="9" class="px-4 py-8 text-center text-slate-500">No leases yet. Use <span class="font-semibold">New lease</span> above.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
