...
<head>
    ...
    <style>
        ...
        .meta { position: relative; z-index: 1; text-align: right; font-size: 12px; color: #475569; line-height: 1.8; }
        ...
        .text { font-size: 13px; line-height: 1.6; color: #0f172a; }
        ...
        .row { display: flex; justify-content: space-between; font-size: 13px; color: #334155; margin-bottom: 8px; }
