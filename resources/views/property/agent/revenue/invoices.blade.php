...
>
    ...
    <x-slot name="actions">
        <button
            ...
            data-property-modal-open="showInvoiceForm" @click="showInvoiceForm = true"
        >
            ...
            <div class="grid gap-3 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-property.quick-create-select
                        ...
                        :create="\App\Support\Property\PmUnitQuickCreateFields::config(collect($units)->map(fn($u) => ['value' => $u->property_id, 'label' => ($u->property?->name ?? 'Unknown property')])->unique('value')->values()->all())"
                    />
                ...
                <div>
                    ...
                    <input id="invoice-issue-date" type="date" name="issue_date" value="{{ old('issue_date', now()->startOfMonth()->toDateString()) }}" required class="mt-1 w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-900 text-sm px-3 py-2" />
