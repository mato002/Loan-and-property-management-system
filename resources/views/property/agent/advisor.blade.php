<x-property-layout>
    ...
    <x-property.page
        title="Ask anything"
        subtitle="Rule-based answers from your live portfolio counts. Connect an LLM later via API key for open-ended questions."
    >
        <div class="max-w-2xl w-full min-w-0 space-y-6">
            <form method="post" action="{{ route('property.advisor.ask') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-gray-800/80 p-4 sm:p-5 shadow-sm space-y-3">
                ...
                <textarea
                    ...
                    placeholder="e.g. What is outstanding in arrears? How many vacant units?"
