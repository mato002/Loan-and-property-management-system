...
>
    <x-slot name="pageModalsAttributes" x-data="{!! \Illuminate\Support\Js::from(['showLeadForm' => $showLeadFormByDefault]) !!}" ></x-slot>
    ...
    <x-slot name="actions">
        <button
            ...
            data-property-modal-open="showLeadForm" @click="showLeadForm = true"
        >
