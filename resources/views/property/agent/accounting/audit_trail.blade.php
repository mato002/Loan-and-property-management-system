...
proceed     <input type="search" name="q" value="{{ $filters['q'] ?? '' }}" placeholder="Search account/ref/source…" class="rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-800 text-sm px-3 py-2 min-w-0 w-full sm:w-72" />
