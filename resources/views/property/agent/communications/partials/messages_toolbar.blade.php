...
<div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-gray-800/80 p-4 shadow-sm space-y-3">
    <div class="flex flex-wrap items-center gap-2">
        ...
        <a href="{{ route('property.communications.messages', absolute: false) }}" class="rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700/50">All</a>
        <a href="{{ route('property.communications.messages', ['period' => 'today'], absolute: false) }}" class="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50">Today</a>
        <a href="{{ route('property.communications.messages', ['period' => 'week'], absolute: false) }}" class="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50">This week</a>
        <a href="{{ route('property.communications.messages', ['period' => 'month'], absolute: false) }}" class="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50">This month</a>
        <a href="{{ route('property.communications.messages', ['channel' => 'sms'], absolute: false) }}" class="rounded-lg border border-emerald-300 px-3 py-1.5 text-xs font-medium text-emerald-700 hover:bg-emerald-50">SMS only</a>
        <a href="{{ route('property.communications.messages', ['channel' => 'email'], absolute: false) }}" class="rounded-lg border border-indigo-300 px-3 py-1.5 text-xs font-medium text-indigo-700 hover:bg-indigo-50">Email only</a>
        <a href="{{ route('property.communications.messages', ['status' => 'failed'], absolute: false) }}" class="rounded-lg border border-rose-300 px-3 py-1.5 text-xs font-medium text-rose-700 hover:bg-rose-50" title="Unresolved failures only (hides rows already sent on retry)">Failed (needs action)</a>
        <a href="{{ route('property.communications.messages', ['has_error' => 'yes'], absolute: false) }}" class="rounded-lg border border-amber-300 px-3 py-1.5 text-xs font-medium text-amber-700 hover:bg-amber-50">With errors</a>
        <a href="{{ route('property.communications.messages', ['duplicates' => 'yes', 'status' => 'sent', 'channel' => 'sms', 'period' => 'today'], absolute: false) }}" class="rounded-lg border border-orange-400 px-3 py-1.5 text-xs font-semibold text-orange-800 hover:bg-orange-50 dark:text-orange-200 dark:hover:bg-orange-950/40">Duplicates today</a>
        <a href="{{ route('property.communications.messages', ['status' => 'failed', 'channel' => 'sms', 'period' => 'today'], absolute: false) }}" class="rounded-lg border border-rose-400 px-3 py-1.5 text-xs font-semibold text-rose-800 hover:bg-rose-50 dark:text-rose-200 dark:hover:bg-rose-950/40">Failed today</a>
        <a href="{{ route('property.communications.messages', ['status' => 'failed', 'channel' => 'sms', 'from' => '2026-06-01', 'to' => '2026-06-01'], absolute: false) }}" class="rounded-lg border border-rose-300 px-3 py-1.5 text-xs font-medium text-rose-700 hover:bg-rose-50">Failed 1 Jun</a>
    </div>
    ...
    <div class="flex flex-wrap items-center gap-2 border-t border-slate-100 dark:border-slate-700 pt-3">
        ...
        @if ($canExportCommunications ?? true)
            <a href="{{ route('property.communications.messages.export', array_merge($exportQuery, ['format' => 'csv']), absolute: false) }}" data-turbo="false" class="rounded-lg border border-indigo-300 px-3 py-1.5 text-xs font-medium text-indigo-700 hover:bg-indigo-50">CSV</a>
            <a href="{{ route('property.communications.messages.export', array_merge($exportQuery, ['format' => 'xls']), absolute: false) }}" data-turbo="false" class="rounded-lg border border-indigo-300 px-3 py-1.5 text-xs font-medium text-indigo-700 hover:bg-indigo-50">Excel</a>
            <a href="{{ route('property.communications.messages.export', array_merge($exportQuery, ['format' => 'pdf']), absolute: false) }}" data-turbo="false" class="rounded-lg border border-indigo-300 px-3 py-1.5 text-xs font-medium text-indigo-700 hover:bg-indigo-50">PDF</a>
        @else
