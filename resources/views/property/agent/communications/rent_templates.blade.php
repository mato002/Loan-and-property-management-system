    ...
    <x-slot name="above">
        ...
        <div
            ...
            x-data="{
                ...
                previewUrl: @js(route('property.communications.rent_templates.preview', absolute: false)),
                csrf: @js(csrf_token()),
                loading: false,
                preview: @js($preview),
        ...
        >
            <div class="lg:col-span-3 space-y-4">
                @if ($canManage)
                    <form
                        method="post"
                        action="{{ route('property.communications.rent_templates.store', absolute: false) }}"
