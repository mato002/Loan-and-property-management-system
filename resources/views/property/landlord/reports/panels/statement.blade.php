<form method="get" id="statement-filters" action="{{ route('property.landlord.reports.index') }}" class="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-gray-800/70 p-3 sm:p-4 grid grid-cols-2 sm:flex sm:flex-wrap items-end gap-2 sm:gap-3 mb-4 w-full min-w-0">
    <input type="hidden" name="panel" value="statement" />
    ...
    <div class="col-span-2 sm:col-span-1 min-w-0">
        ...
        <select name="property_id" id="statement-property" class="w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm">
    ...
    <div class="col-span-2 sm:col-span-1 min-w-0">
        ...
        <select name="unit_id" id="statement-unit" class="w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        propertySelect.addEventListener('change', function () { unitSelect.value = ''; form.submit(); });
        unitSelect.addEventListener('change', function () { form.submit(); });
    });
