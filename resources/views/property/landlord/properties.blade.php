                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        @forelse ($vacancyUnits ?? [] as $u)
                            ...
                            @endphp
                            <tr class="border-t border-slate-100 dark:border-slate-700 {{ \App\Support\Property\WorkspaceRowAlert::trClass($rowTone) }}" @if ($cellStyle !== '') data-row-tone="{{ $rowTone }}" @endif>
