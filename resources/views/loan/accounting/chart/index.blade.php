                        ...
                        <form method="post" :action="formAction" class="mt-4 space-y-5">
                            ...
                            <section>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <input type="text" x-model="form.code" placeholder="Account Code (auto-generated by type)" readonly disabled class="w-full rounded-lg border border-slate-300 bg-slate-100 px-3 py-2 text-sm text-slate-600 focus:border-teal-600 focus:outline-none focus:ring-1 focus:ring-teal-600">
