...
>
    <details data-property-dropdown-root data-property-mobile-action-sheet>
        <summary
        ...
        <div
            ...
            class="{{ $width }} overflow-hidden rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-gray-800 shadow-lg py-0.5"
        >
            {{ $slot }}
        </div>
    </details>
