...
@endphp
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full {{ $propertyPortalThemeClass }}" data-pwa-context="portal" {!! \App\Support\Property\PropertyBrandPalette::htmlRootAttributes('portal') !!}>
    <head>
