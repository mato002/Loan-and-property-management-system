        ...
        <div class="lg:col-span-1 space-y-8">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('superadmin.ops.index') }}" class="col-span-2 group flex flex-col items-center justify-center p-4 rounded-xl border-2 border-emerald-100 bg-emerald-50/50 hover:bg-emerald-50 hover:border-emerald-200 transition">
                        <svg class="h-7 w-7 text-emerald-600 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        <span class="text-sm font-bold text-emerald-800">Operations console</span>
                        <span class="text-[10px] text-emerald-700 mt-1">Landlord scope &amp; commands</span>
                    </a>
                </div>
