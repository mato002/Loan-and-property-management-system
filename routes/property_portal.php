...
Route::middleware(['auth', 'module.access:property', 'property.system'])->group(function () {
    ...
    Route::middleware(['property.portal:agent'])->prefix('property')->name('property.')->group(function () {
        ...
        Route::get('/settings/system-setup/property-onboarding-fields', [PropertySettingsStoreWebController::class, 'systemSetupPropertyOnboardingFields'])->middleware('superadmin')->name('settings.system_setup.property_onboarding_fields');
        Route::post('/settings/system-setup/property-onboarding-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupPropertyOnboardingFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.property_onboarding_fields.store');
        Route::get('/settings/system-setup/unit-fields', [PropertySettingsStoreWebController::class, 'systemSetupUnitFields'])->middleware('superadmin')->name('settings.system_setup.unit_fields');
        Route::post('/settings/system-setup/unit-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupUnitFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.unit_fields.store');
        Route::get('/settings/system-setup/amenity-fields', [PropertySettingsStoreWebController::class, 'systemSetupAmenityFields'])->middleware('superadmin')->name('settings.system_setup.amenity_fields');
        Route::post('/settings/system-setup/amenity-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupAmenityFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.amenity_fields.store');
        Route::get('/settings/system-setup/landlord-fields', [PropertySettingsStoreWebController::class, 'systemSetupLandlordFields'])->middleware('superadmin')->name('settings.system_setup.landlord_fields');
        Route::post('/settings/system-setup/landlord-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupLandlordFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.landlord_fields.store');
        Route::get('/settings/system-setup/lead-fields', [PropertySettingsStoreWebController::class, 'systemSetupLeadFields'])->middleware('superadmin')->name('settings.system_setup.lead_fields');
        Route::post('/settings/system-setup/lead-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupLeadFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.lead_fields.store');
        Route::get('/settings/system-setup/rental-application-fields', [PropertySettingsStoreWebController::class, 'systemSetupRentalApplicationFields'])->middleware('superadmin')->name('settings.system_setup.rental_application_fields');
        Route::post('/settings/system-setup/rental-application-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupRentalApplicationFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.rental_application_fields.store');
        Route::get('/settings/system-setup/tenant-fields', [PropertySettingsStoreWebController::class, 'systemSetupTenantFields'])->middleware('superadmin')->name('settings.system_setup.tenant_fields');
        Route::post('/settings/system-setup/tenant-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupTenantFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.tenant_fields.store');
        Route::get('/settings/system-setup/lease-fields', [PropertySettingsStoreWebController::class, 'systemSetupLeaseFields'])->middleware('superadmin')->name('settings.system_setup.lease_fields');
        Route::post('/settings/system-setup/lease-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupLeaseFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.lease_fields.store');
        Route::get('/settings/system-setup/maintenance-fields', [PropertySettingsStoreWebController::class, 'systemSetupMaintenanceFields'])->middleware('superadmin')->name('settings.system_setup.maintenance_fields');
        Route::post('/settings/system-setup/maintenance-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupMaintenanceFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.maintenance_fields.store');
        Route::get('/settings/system-setup/vendor-fields', [PropertySettingsStoreWebController::class, 'systemSetupVendorFields'])->middleware('superadmin')->name('settings.system_setup.vendor_fields');
        Route::post('/settings/system-setup/vendor-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupVendorFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.vendor_fields.store');
        Route::get('/settings/system-setup/invoice-fields', [PropertySettingsStoreWebController::class, 'systemSetupInvoiceFields'])->middleware('superadmin')->name('settings.system_setup.invoice_fields');
        Route::post('/settings/system-setup/invoice-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupInvoiceFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.invoice_fields.store');
        Route::get('/settings/system-setup/tenant-notice-fields', [PropertySettingsStoreWebController::class, 'systemSetupTenantNoticeFields'])->middleware('superadmin')->name('settings.system_setup.tenant_notice_fields');
        Route::post('/settings/system-setup/tenant-notice-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupTenantNoticeFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.tenant_notice_fields.store');
        Route::get('/settings/system-setup/movement-fields', [PropertySettingsStoreWebController::class, 'systemSetupMovementFields'])->middleware('superadmin')->name('settings.system_setup.movement_fields');
        Route::post('/settings/system-setup/movement-fields', [PropertySettingsStoreWebController::class, 'storeSystemSetupMovementFields'])->middleware(['superadmin', 'property.permission:settings.manage'])->name('settings.system_setup.movement_fields.store');
