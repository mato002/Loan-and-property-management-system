...
class PropertyCommunicationTemplateService
{
    ...
    public function templateVariables(array $context): array
    {
        ...
        return [
            ...
            'balance' => (string) ($context['balance'] ?? ''),
            'balance_due' => (string) ($context['balance_due'] ?? $context['balance'] ?? ''),
            'invoice_amount' => (string) ($context['invoice_amount'] ?? ''),
            'amount_paid' => (string) ($context['amount_paid'] ?? ''),
            'amount' => (string) ($context['amount'] ?? $context['balance'] ?? ''),
            'partial_payment_note' => (string) ($context['partial_payment_note'] ?? ''),
            'due_date' => (string) ($context['due_date'] ?? ''),
